...
This provided us with information about the dimensions of our data set, along with the frequency of the various data types in the data.
...
It appear that winning teams often commit 1 or fewer turnovers per game while losing teams often commit 1-2 turnovers per game.
...
The densities for the winning team's yards gained and the losing team's yards gained don't show any gross departures from normality, which is interesting.
