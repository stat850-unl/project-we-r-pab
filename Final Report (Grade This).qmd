...
In 2013 and 2015, the Broncos managed to pull off victories in approximately 79% of their games; culminating in a Super Bowl appearance in 2013 and a Super Bowl win in 2015. Unfortunately, they did not have any good years from 2016-2019.
...
#### Who was winning the most number of 'WildCard' games from 2000 to 2019? AFC or NFC?

```{r,echo = FALSE, warning = FALSE}
Wildcard_week<- filter(footballgames, week =="WildCard")
dim(Wildcard_week)
