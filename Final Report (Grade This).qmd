...
#### AFC West teams pts_win vs yds_win scatter plot.
```{r, echo = FALSE, warning = FALSE, message = FALSE} 
afc_west_teams= c("Denver Broncos", "Kansas City Chiefs", "Las Vegas Raiders","Los Angeles Chargers", "San Diego Chargers")
