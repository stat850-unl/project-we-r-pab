...
The Superbowl games and the games that are 'tied' are not included in the analyses. Then, a box plot of the variable 'pts_win' is created based on 'win_conf' for comparison. 
...
The above plot shows the distribution of points won by winning conference's teams at each of the conference's teams home.
The mean, median, first and third quartile all looks similar in both of the plots. Whenever the game was played at NFC's home, NFC won
28.45 points on average compared to AFC's 28.42.
The maximum number of points won by an AFC teams playing at NFC's home is 55 compared to 57 of NFC's teams.  
Similarly, when the games were played on AFC's turf, the average points won by NFC's teams is 28 vs NFC's 28.7. 
On one occassion, one AFC team won 56 points and is the maximum points won in the AFC's home. 
The maximum points won by NFC team at AFC's home is 51 and the the minimum is 9. 

#### Which conference won the most Superbowls?
...
For this, a subset of original data where 'week' is 'Superbowl' only is filtered out. Then, the winning conference on each of these games is identified with reference from the list 'afc_teams' and stored in a new variable 'win_conf'. 
...
Out of the 20 Superbowl matches, AFC's team won on 13 occassions compared to NFC's teams 7 wins. 
