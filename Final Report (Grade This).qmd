...
pairs(footballgames[,10:16])

# histograms.bar plots of home team,away team, winner, tie, day, hometeamname, hometeamcity,awayteamname,awayteamcity

par(mfrow = c(3, 2)) 

footballgames %>%
  ggplot(aes(y = pts_win)) + 
  geom_boxplot() + 
  ggtitle("Boxplot of Points Scored by the Winning Team") +
  ylab("Number of Points Scored")

footballgames %>%
  ggplot(aes(y = pts_loss)) + 
  geom_boxplot() + 
  ggtitle("Boxplot of Points Scored by the Losing Team") +
  ylab("Number of Points Scored")

footballgames %>%
  ggplot(aes(y = yds_win)) + 
  geom_boxplot() + 
  ggtitle("Boxplot of Yards Gained by the Winning Team") +
  ylab("Number of Yards")

footballgames %>%
  ggplot(aes(y = yds_loss)) + 
  geom_boxplot() + 
  ggtitle("Boxplot of Yards Gained by the Losing Team") +
  ylab("Number of Yards")

footballgames %>%
  ggplot(aes(y = turnovers_win)) + 
  geom_boxplot() + 
  ggtitle("Boxplot of Turnovers Committed by the Winning Team") +
  ylab("Number of Turnovers")

footballgames %>%
  ggplot(aes(y = turnovers_loss)) + 
  geom_boxplot() + 
  ggtitle("Boxplot of Turnovers Committed by the Losing Team Team") +
  ylab("Number of Turnovers")
