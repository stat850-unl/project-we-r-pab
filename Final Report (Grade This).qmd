...
## Introduction
Have you ever seen a baseball player smack a home run on t.v., with the launch angle, distance traveled, and exit velocity immediately depicted on screen?
...
If not, chances are you will at some point. The world of data is constantly getting bigger and bigger, with increasing numbers of applications, including in sports.
...
Every season starts with a three-week preseason in the month of August, followed by 18 weeks of regular season. The regular season games run from early September to early January.
During a regular season, each team plays 17 games and has one bye week (one week during the course of the season where they do not play a game). 
After the regular season concludes, seven teams from each conference (four division winners and three wild card teams) would advance to the playoffs round.
The playoffs are a single elimination tournament that determine the two teams that will play the Super Bowl.
The Super Bowl is the last match between the AFC and NFC champions.
