...
In the field of sports analytics, experts use data and other quantitative methods to measure performance within the sport of interest in order to make decisions. Through analyzing sports data, sports analytics can inform players and coaches on how to strategize for future games. Sports organizations also often use sports analysis for business decisions, while for the public, the information can be utilized as reasoning to support their favorite team, and even for betting purposes. On account of the fact that American Football is the most dominant sports in the country, in this paper, we will try to analyze the sports performance of NFL Teams.

To provide a little bit of context, the National Football League (NFL) is an American Football League, consisting of 32 teams. Each team belongs to either AFC (American Football Conference), or NFC (National Football Conference); and there are 16 teams in each conference. Every season starts with a three-week preseason in the month of August, followed by 18 weeks of regular season. The regular season games run from early September to early January. During a regular season, each team plays 17 games and has one bye week (one week during the course of the season where they do not play a game). After the regular season concludes, seven teams from each conference (four division winners and three wild card teams) would advance to the playoffs round. The playoffs are a single elimination tournament that determine the two teams that will play the Super Bowl. The Super Bowl is the last match between the AFC and NFC champions.
...
Compare number of games won by the home team to number of games won by the away team, can compare winning percentage to number of super bowls won compare games won by Broncos to average number of games won for all teams
