...
plot4<-ggplot(data = afcvsnfc) +
  geom_bar(mapping = aes(x = win_team, y = ..prop.., group=1, stat="identity"), stat="count")+ggtitle("Percentage of wins AFC vs NFC")+xlab("Winning Team")+ylab("Winning Percentage %")+scale_y_continuous(labels = scales::percent, limits=c(0,1))
ggplotly(plot4)
```
