...
# Forecast and plot
fitwinpercentages %>% forecast(h = 3) %>% autoplot(broncosts)
```
...
# Forecast and plot
fitwinpercentages %>% forecast(h = 3) %>% autoplot(chiefsts)
```
...
# Forecast and plot
fitwinpercentages %>% forecast(h = 3) %>% autoplot(chargersts)
```
...
# Forecast and plot
fitwinpercentages %>% forecast(h = 3) %>% autoplot(raidersts)
```
