...
Compare number of games won by the home team to number of games won by the away team
Derive winning percentage variable for teams, can compare winning percentage to number of super bowls won
compare games won by Broncos to average number of games won for all teams
...
While the focus of this analysis is not on statistical modeling, it might be helpful to compare the number of games
won by the home team to the number of games won by the road team using a t-test. 
