...
# convert locationof win to categorical
...
footballgames %>%
  ...
  ggtitle("Comparing Number of Games Won by Away Teams to the Number of Games Won by the Home Team") +
    scale_fill_discrete(labels=c('Away Team Wins', 'Home Team Wins')) 
